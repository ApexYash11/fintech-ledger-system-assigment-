...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_audit_logs_idempotency_key"), "audit_logs", ["idempotency_key"], unique=False
    )
    op.create_table(
        "brands",
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(length=255), nullable=False),
        sa.Column(
            "status", sa.Enum("ACTIVE", "SUSPENDED", "DELETED", name="userstatus"), nullable=False
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(
        "ix_ledger_user_created", "ledger_entries", ["user_id", "created_at"], unique=False
    )
    op.create_index(
        "ix_ledger_reference", "ledger_entries", ["reference_type", "reference_id"], unique=False
    )
    op.create_table(
        "sales",
        sa.Column("id", sa.String(length=36), nullable=False),
        ...
        sa.Column("earnings", sa.Numeric(12, 2), nullable=False),
        sa.Column("currency", sa.String(length=3), nullable=False),
        sa.Column(
            "status", sa.Enum("PENDING", "APPROVED", "REJECTED", name="salestatus"), nullable=False
        ),
    ...
    op.create_index("ix_sales_status_created", "sales", ["status", "created_at"], unique=False)
    op.create_table(
        "user_balances",
        sa.Column("id", sa.String(length=36), nullable=False),
        sa.Column("user_id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        op.f("ix_user_balances_created_at"), "user_balances", ["created_at"], unique=False
    )
    op.create_table(
        "withdrawals",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        "ix_withdrawals_status_created", "withdrawals", ["status", "created_at"], unique=False
    )
    op.create_index(
        "ix_withdrawals_user_created", "withdrawals", ["user_id", "created_at"], unique=False
    )
    op.create_index(op.f("ix_withdrawals_user_id"), "withdrawals", ["user_id"], unique=False)
    op.create_index(
        "ix_withdrawals_user_status", "withdrawals", ["user_id", "status"], unique=False
    )
    op.create_table(
        "payouts",
        sa.Column("id", sa.String(length=36), nullable=False),
        ...
        sa.Column("amount", sa.Numeric(12, 2), nullable=False),
        sa.Column(
            "type", sa.Enum("ADVANCE", "FINAL_SETTLEMENT", name="payouttype"), nullable=False
        ),
        sa.Column(
            "status", sa.Enum("PENDING", "COMPLETED", "FAILED", name="payoutstatus"), nullable=False
        ),
        sa.Column("idempotency_key", sa.String(length=255), nullable=False),
        sa.Column("gateway_reference", sa.String(length=255), nullable=True),
